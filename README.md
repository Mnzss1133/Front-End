...
- o sistema também dever ser acessavel a partir do aplicativo do Passeio Carioca;
...
Irá conter um sistema de audio, que vai reproduzir a voz da estátua feita através de inteligência artificial.
