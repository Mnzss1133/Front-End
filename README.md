...
### What 
#### (O que -> Projeto) - O que é o projeto? E o que é o sistema? 
...
#### (Por que -> Projeto) - Porque esse projeto é necessário? -> No que ele vai ajudar o cliente?
...
## Casos de Uso: Visualizar o feed
...
## Casos de Uso: Acessar a experiência
